...
while true; do
    read -p "Do you wish to configure Wazuh with the custom ruleset? WARNING - This script will replace all of your current custom Wazuh Rules. Please proceed with caution and it is recommended to manually back up your rules... continue? " yn
    case $yn in
        [Yy]* ) break;;
        [Nn]* ) exit;;
